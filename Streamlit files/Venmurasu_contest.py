...
The first one is to parallelly view clean Tamil data and corresponding clean English data. To visualise only the cleaned data, ensure that all other drop-down options are set to 'NONE'.
